# Countdown is a British game show with number and word puzzles. The letters round consists of the contestant
# picking 9 shuffled letters - either picking from the vowel pile or the consonant pile. The contestants are given
# 30 seconds to try to come up with the longest English word they can think of with the available letters - letters
...
m = lambda x: {ch: x.count(ch) for ch in x}


def longest_word(l, words):
    l = l.upper()
    pool = {ch: l.count(ch) for ch in l}
