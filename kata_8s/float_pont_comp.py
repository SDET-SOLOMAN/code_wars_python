...
# False
# The solution is to check if a computed value is close to an expected value, without
# requiring them to be exactly equal. It seems very easy, but many katas test float results the wrong way.
#
# Task
#
# You have:
