...
#
# Write a function that accepts an integer array and returns true if the array is an array
# of all possibilities, else false.
#
# Examples:
#
# [1,2,0,3] => True
...
def is_all_possibilities(arr):
    return all(x in arr for x in range(len(arr)))


def is_all_possibilities2(arr):
    return set(arr) == set(x for x in range(len(arr)))