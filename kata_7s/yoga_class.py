# Description Lets imagine a yoga classroom as a Square 2D Array of Integers classroom, with each integer
# representing a person, and the value representing their skill level.
#
# classroom = [
#             [3,2,1,3],
#             [1,3,2,1],
...
#             ]
#
# poses = [1,7,5,9,10,21,4,3] During a yoga class the instructor gives a list of integers poses representing a yoga
# pose that each person in the class will attempt to complete.
#
