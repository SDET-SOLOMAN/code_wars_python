...
# There are 4 hats, 2 black and 2 white. Each person is given a hat. None of them can see their own hat, but person
# a can see the hats of b and c, while person b can see the hat of person c. Neither c nor d can see any hats.
#
# Once a person figures out the color of their hat, they shout it.
#
# Four men, in decreasing height, standing behind each other, wearing black and white colored hats, with the last
# man on the right hidden behind the wall.
#
# Your task is to return the person who will guess their hat first. You can assume that they will speak only when
# they reach a correct conclusion.
#
# Input/Output
# [input] string a
