# Lucy loves to travel. Luckily she is a renowned computer scientist and gets
# to travel to international conferences using her department's budget.
#
# Each year, Society for Exciting Computer Science Research (SECSR) organizes
# several conferences around the world. Lucy always picks one conference from that
# list that is hosted in a city she hasn't been to before, and if that leaves her with
# more than one option, she picks the conference that she thinks would be most relevant for her field of research.
#
...
# citiesOffered, a list of cities that will host SECSR conferences this year, given as an array of
# strings. citiesOffered will already be ordered in terms of the relevance of the conferences for Lucy's
...
# If all of the offered conferences are hosted in cities that Lucy has visited before, the function
# should return 'No worthwhile conferences this year!' (Nothing in Haskell)
# Example:
#
