...
def dirReduc(ar):
    ar = ' '.join(x for x in ar)

    ar = ar.replace('NORTH SOUTH', ' ').replace('SOUTH NORTH', ' ').replace('WEST EAST', ' ').replace('EAST WEST',
                                                                                                      ' ').replace("  ",
                                                                                                                   "")

    if 'NORTH SOUTH' in ar or 'SOUTH NORTH' in ar or 'WEST EAST' in ar or 'EAST WEST' in ar:
        return dirReduc(ar.split())

    return ar.split()


o = {'NORTH': 'SOUTH', 'EAST': 'WEST', 'SOUTH': 'NORTH', 'WEST': 'EAST'}
